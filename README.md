...
![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=16&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Web+Dev+%26+Applied+AI;Building+things+that+actually+work;Learning+in+public)
...
I'm a Diploma CS&E student from India. I'm into web development and curious about AI — not just how to use it, but eventually how it works at its core. Right now I'm focused on strengthening my web dev skills and exploring AI applications, building towards diving deeper into AI and data during my Bachelor's. I tend to wander into whatever is new to me and learn by building something with it rather than just reading about it.

```yaml
name      : Abhinav Kishore
location  : India
education : Diploma in Computer Science & Engineering
interests : Web Development, AI Applications, Data & ML (next)
